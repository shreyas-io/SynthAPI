...
export type PyodideWorkerData = {
  worker_id: number;
  python_packages: string[];
  pyodide_index_url: string | undefined;
};
...
type PoolWorker = {
  ...
  current: QueuedRequest | undefined;
  boot_timeout: ReturnType<typeof setTimeout> | undefined;
};

type PyodideWorkerPoolResolvedConfig = Required<
  Omit<PyodideWorkerPoolConfig, "worker_memory_limit_mb" | "pyodide_index_url">
> & {
  worker_memory_limit_mb: number | undefined;
  pyodide_index_url: string | undefined;
};
...
export class PyodideWorkerPool {
  private readonly config: PyodideWorkerPoolResolvedConfig;
